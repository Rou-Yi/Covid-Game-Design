...
from sound import play_soundtrack_win, play_soundtrack_loss
...
class Ending_page:
    ...
    def draw(self, win):
        ...
        pygame.draw.rect(surface, (0, 0, 0, 170), [0, 0, WIN_WIDTH, WIN_HEIGHT], 0)
    ...
    def Win(cls, level):
        ...
        btn_list = [Button(NIGHT_WIN_ENDING_BTN, "time: night to day", 600, 550)]
    ...
    @classmethod
    def Loss(cls):
        btn_list = [Button(BACK_BTN, "main menu night", 600, 550)]
