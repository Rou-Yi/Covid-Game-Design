...
from sound import cat_attack_daytime_soundtrack


class Cats:
    # [一般圖像. 攻擊中的圖像. 名字. 血量. 攻擊哪隻病毒. 對應按鍵]
    def __init__(self, image, attack_image, name, attack_objects, key_object):
        ...
        self.attack_image = attack_image  # 攻擊中的圖像
    ...
    @classmethod
    def Vaccine(cls):
        vaccine = cls(VACCINE_CAT_IMAGE_D, VACCINE_CAT_ATTACK_IMAGE_D, 'vaccine',
