...
class Game_day:
    def __init__(self, level, volume_setting, current_volume):
        self.sound = pygame.mixer.Sound("./sound/Game Background Music Daytime  (mixkit-keeping-fit-82).mp3")
        ...
        self.game_model = GameModel(level, self.sound)  # level core of the game (database, game logic...)
